-- ==========================================
-- HanaHire Database Migration V2
...
-- We'll add a check constraint instead to ensure email exists
...
-- Show demo accounts
SELECT 'Demo Candidate' as account_type, email, name FROM candidates WHERE email = 'demo.seeker@hanahire.com'
UNION ALL
SELECT 'Demo Employer', email, business_name FROM employers WHERE email = 'demo.employer@hanahire.com';
