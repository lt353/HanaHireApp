...
export const JOB_CATEGORIES = {
  ...
  payRanges: [
    ...
    '$30-40k/year', '$40-50k/year', '$50-60k/year', '$60k+/year', 'Commission-based'
  ]
};
...
export const CANDIDATE_CATEGORIES = {
  ...
  availability: [
    ...
    'End of school year', 'Seasonal'
  ],
  workStyles: [
    'Collaborative', 'Detail-oriented', 'Fast-paced', 'Outgoing', 'Focused', 
    'Hands-on', 'Creative', 'Efficient', 'Leadership', 'Nurturing', 
    'Professional', 'Problem-solver', 'Caring', 'Energetic', 'Driven', 
