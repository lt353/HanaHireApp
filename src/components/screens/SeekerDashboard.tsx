...
import { Plus, Play, Video, Settings as SettingsIcon, Users, Edit3, LogIn, LogOut, Briefcase, MapPin, DollarSign, Building2, ExternalLink } from "lucide-react";
      ...
      {!isLoggedIn && (
        <div className="p-6 sm:p-8 bg-gradient-to-r from-[#0077BE]/5 to-[#2ECC71]/5 rounded-[2rem] sm:rounded-[3rem] border border-[#0077BE]/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
          <div className="space-y-2 flex-1">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-medium">No sign-up required to explore. Create an account when you're ready to apply.</p>
          </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 sm:gap-10">
        <div className="space-y-3 sm:space-y-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-500 font-medium">
            {isLoggedIn ? "Manage your intro video and track match reveals." : "Browse jobs and get started when ready."}
          </p>
        </div>
      ...
      {isLoggedIn && (
        <div className="grid lg:grid-cols-3 gap-8 sm:gap-12 md:gap-20">
          ...
          <aside className="space-y-8 sm:space-y-12">
            <div className="p-8 sm:p-10 md:p-12 bg-gray-900 text-white rounded-[2.5rem] sm:rounded-[3.5rem] md:rounded-[4.5rem] space-y-8 sm:space-y-12 shadow-2xl relative overflow-hidden group">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tighter leading-none">Activity</h3>
              <div className="space-y-6 sm:space-y-8">
                <div className="flex justify-between items-end border-b border-white/10 pb-4 sm:pb-6">
                  <span className="text-white/40 font-black uppercase tracking-[0.3em] text-[9px]">Profile Views</span>
                  <span className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter transition-all group-hover:text-[#0077BE]">42</span>
                </div>
              </div>
