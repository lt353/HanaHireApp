    ...
    <div className="pb-24">
      ...
      <section className="py-12 sm:py-24 px-4 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
        <div className="space-y-6 sm:space-y-10 text-center lg:text-left">
          <div className="space-y-4 sm:space-y-6">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-gray-900 tracking-tight leading-none">
              Hire the <span className="text-[#1A7A84]">Person</span>,<br className="hidden sm:inline" />
              Not the Paper
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center lg:justify-start pt-4 sm:pt-6">
            <button
              ...
              className="flex-1 bg-[#1A7A84] text-white py-4 px-6 sm:py-5 sm:px-8 rounded-[1.5rem] hover:scale-[1.02] transition-all shadow-xl shadow-[#1A7A84]/20 font-black text-base sm:text-lg tracking-tight uppercase"
            >
              Looking for a job
            </button>
            <button
              onClick={() => onSelectRole("employer")}
              className="flex-1 bg-[#D25B3A] text-white py-4 px-6 sm:py-5 sm:px-8 rounded-[1.5rem] hover:scale-[1.02] transition-all shadow-xl shadow-[#D25B3A]/20 font-black text-base sm:text-lg tracking-tight uppercase"
            >
              Looking to hire
            </button>
          </div>
        ...
        <div className="relative group">
          <div className="absolute -inset-4 bg-[#1A7A84]/10 rounded-[5rem] blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'rgba(129, 178, 154, 0.2)', color: '#81B29A' }}>
                <Video size={28} className="sm:w-8 sm:h-8" />
              </div>
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-4xl sm:text-5xl font-black text-[#1A7A84]">1</span>
            ...
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-4xl sm:text-5xl font-black text-[#1A7A84]">2</span>
            ...
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-4xl sm:text-5xl font-black text-[#D25B3A]">3</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg border-2 border-gray-100">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'rgba(242, 204, 143, 0.3)', color: '#D25B3A' }}>
                <Sparkles size={28} className="sm:w-8 sm:h-8" />
              </div>
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-4xl sm:text-5xl font-black text-[#D25B3A]">1</span>
            ...
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg border-2 border-gray-100">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-4xl sm:text-5xl font-black text-[#D25B3A]">2</span>
            ...
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg border-2 border-gray-100">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-4xl sm:text-5xl font-black text-[#1A7A84]">3</span>
      ...
      {/* Key Features */}
      <section className="py-12 sm:py-20 px-4 bg-gradient-to-b from-[#1A7A84]/5 to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 space-y-3 sm:space-y-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center space-y-3 sm:space-y-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white shadow-lg flex items-center justify-center text-[#1A7A84] mx-auto">
            ...
            <div className="text-center space-y-3 sm:space-y-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white shadow-lg flex items-center justify-center text-[#D25B3A] mx-auto">
      ...
      <section className="py-12 sm:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center pt-4 sm:pt-6">
            <button
              onClick={() => onSelectRole("seeker")}
              className="bg-[#1A7A84] text-white py-4 sm:py-6 px-8 sm:px-12 rounded-[1.5rem] hover:scale-[1.02] transition-all shadow-xl shadow-[#1A7A84]/20 font-black text-base sm:text-xl tracking-tight uppercase"
            >
              I'm Job Seeking
            </button>
            <button
              onClick={() => onSelectRole("employer")}
              className="bg-[#D25B3A] text-white py-4 sm:py-6 px-8 sm:px-12 rounded-[1.5rem] hover:scale-[1.02] transition-all shadow-xl shadow-[#D25B3A]/20 font-black text-base sm:text-xl tracking-tight uppercase"
            >
              I'm Hiring
            </button>
          </div>
