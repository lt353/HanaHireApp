...
export const Home: React.FC<HomeProps> = ({ onSelectRole }) => {
  ...
  className="flex-1 text-white py-4 px-6 sm:py-5 sm:px-8 rounded-[1.5rem] hover:scale-[1.02] transition-all shadow-xl font-black text-base sm:text-lg tracking-tight uppercase"
  style={{ backgroundColor: '#A63F8E', boxShadow: '0 20px 25px -5px rgba(120,2,98,0.2)' }}
>
  Looking to hire
</button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="flex-1 bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 space-y-4 sm:space-y-6 shadow-lg border-2 border-gray-100">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'rgba(242, 204, 143, 0.3)', color: '#A63F8E' }}>
