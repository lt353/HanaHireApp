      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-10 order-2 lg:order-1">
            ...
            {/* Suggestion Box */}
            <div className="p-6 bg-[#148F8B]/5 border border-[#148F8B]/10 rounded-3xl flex gap-4 items-start">
              <div className="p-2 bg-[#148F8B] rounded-xl text-white">
                <Info size={20} />
              </div>
              <div className="space-y-1">
                <p className="text-xs font-black text-[#148F8B] uppercase tracking-widest">Based on your skills, we suggest:</p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center">
                ...
                <div className="w-full md:flex-1 space-y-2">
                  ...
                  <div className="relative">
                    <select 
                      ...
                      className="w-full appearance-none p-5 rounded-2xl bg-white border border-gray-200 font-bold focus:ring-4 ring-[#148F8B]/10 outline-none transition-all"
                    >
                ...
                <div className="w-full md:flex-[1.5] space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-gray-600 ml-2 flex items-center gap-1">
                    Primary Skill <span className="text-[#A63F8E]">*</span>
                  </label>
                  <div className="relative">
                    <select 
                      value={primarySkill}
                      onChange={(e) => setPrimarySkill(e.target.value)}
                      className={`w-full appearance-none p-5 rounded-2xl bg-white border-2 font-black focus:ring-4 ring-[#148F8B]/10 outline-none transition-all ${noPrimarySkill ? 'border-[#A63F8E]' : 'border-gray-200'}`}
                    >
              ...
              <div className="pt-6 border-t border-gray-50 space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span className={`text-[10px] font-black uppercase tracking-widest ${isTooLong ? 'text-[#A63F8E]' : 'text-gray-300'}`}>
              ...
              <AnimatePresence>
                {(errors.primary || errors.length || errors.blocked) && (
                  <motion.div 
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="p-5 bg-[#A63F8E]/5 border border-[#A63F8E]/10 rounded-2xl flex gap-3 items-center text-[#A63F8E]"
                  >
                    <AlertCircle size={20} />
            ...
            <div className="border border-gray-100 rounded-[2rem] overflow-hidden">
              <button
                ...
                className="w-full p-6 flex justify-between items-center hover:bg-[#F3EAF5]/30 transition-colors hover:scale-105 active:scale-95 transition-all duration-200"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#A63F8E]/10 flex items-center justify-center text-[#A63F8E]">
                    <Check size={16} />
                  </div>
                ...
                {isGuidelinesOpen && (
                  ...
                  >
                    <div className="p-8 pt-0 space-y-4 text-sm font-medium text-gray-500">
                      <div className="flex gap-3"><span className="text-[#A63F8E]">✓</span> Choose skills that match jobs you want</div>
                      <div className="flex gap-3"><span className="text-[#A63F8E]">✓</span> Be specific but not too narrow</div>
                      <div className="flex gap-3"><span className="text-[#A63F8E]">✗</span> Don't include your name</div>
                      <div className="flex gap-3"><span className="text-[#A63F8E]">✗</span> Don't include contact information</div>
                      <div className="flex gap-3"><span className="text-[#A63F8E]">✗</span> Don't include company names</div>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <div className="relative group">
              ...
              <div className="bg-white border border-gray-100 rounded-[3.5rem] overflow-hidden shadow-2xl p-1 shadow-[#148F8B]/10">
                <div className="aspect-video relative bg-gray-100">
                  <div className="absolute inset-0 bg-[#148F8B]/20 flex items-center justify-center backdrop-blur-[60px]">
                ...
                <div className="p-12 space-y-8">
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <span className="px-4 py-2 bg-[#148F8B]/5 text-[10px] font-black text-[#148F8B] rounded-xl uppercase tracking-widest flex items-center gap-2">
                  ...
                  <div className="pt-8 border-t border-gray-50 flex gap-4">
                    <div className="h-16 w-16 bg-[#F3EAF5]/30 rounded-2xl shrink-0" />
                    <div className="flex-1 h-16 bg-[#148F8B] rounded-2xl shadow-xl shadow-[#148F8B]/20" />
                  </div>
                </div>
              </div>
              
              {/* Floating Badge */}
              <div className="absolute -top-4 -right-4 bg-[#A63F8E] text-white px-6 py-2 rounded-full font-black text-[10px] uppercase tracking-widest shadow-xl shadow-[#A63F8E]/30 rotate-3 group-hover:rotate-0 transition-transform">
                Live Preview
              </div>
            </div>

            <div className="p-6 bg-[#F3EAF5]/30 rounded-[2rem] text-center">
        ...
        <div className="mt-16 pt-8 border-t border-gray-100 flex flex-col gap-4 max-w-xl mx-auto lg:mx-0">
          <Button
            ...
            className={`h-20 text-xl rounded-[1.5rem] shadow-2xl transition-all hover:scale-105 active:scale-95 duration-200 ${isValid ? 'shadow-[#148F8B]/30' : 'bg-gray-200 shadow-none'}`}
            onClick={handleSave}
          >
          ...
          <button
            ...
            className="py-4 text-sm font-black text-[#148F8B] uppercase tracking-[0.2em] hover:opacity-70 transition-opacity hover:scale-105 active:scale-95 transition-all duration-200"
          >
            Use Suggested Title
          </button>
        </div>
