    ...
    <nav className="hidden md:flex sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm px-3 sm:px-4 md:px-8 h-20 items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-4 shrink-0">
        ...
        {isLoggedIn ? (
          <Button
            onClick={onLogout}
            className="h-9 sm:h-10 md:h-12 px-3 sm:px-4 md:px-6 text-[10px] sm:text-xs md:text-sm bg-gray-700 hover:bg-gray-800 text-white font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all duration-200"
          >
            Sign Out
          </Button>
        ) : (
          <div className="flex gap-1 sm:gap-2">
            <Button
              ...
              className="h-9 sm:h-10 md:h-12 px-2 sm:px-3 md:px-4 text-[10px] sm:text-xs md:text-sm bg-gray-700 hover:bg-gray-800 text-white font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all duration-200"
            >
              Log In
            </Button>
            <Button
              onClick={() => onShowAuth("signup")}
              className="h-9 sm:h-10 md:h-12 px-2 sm:px-3 md:px-4 text-[10px] sm:text-xs md:text-sm bg-[#1A7A84] hover:bg-[#1A7A84]/90 text-white font-black uppercase tracking-widest shadow-lg shadow-[#1A7A84]/20 hover:scale-105 active:scale-95 transition-all duration-200"
            >
              Sign Up
            </Button>
          </div>
