  ...
  return (
    <nav className="hidden md:flex sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm px-3 sm:px-4 md:px-8 h-20 items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-2 sm:gap-4 md:gap-10 min-w-0 flex-1">
        <button
          onClick={onReset}
          className="text-xl sm:text-2xl md:text-3xl font-black text-[#0077BE] tracking-tighter flex items-center gap-1 sm:gap-2 group shrink-0 hover:scale-105 active:scale-95 transition-all duration-200"
        >
      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-4 shrink-0">
        {isRoleSelected && (
          <>
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-100 hover:border-[#0077BE] hover:bg-[#0077BE]/5 transition-all text-[9px] font-black uppercase tracking-widest text-gray-400 hover:text-[#0077BE] hover:scale-105 active:scale-95 duration-200"
            >
        ...
        {isLoggedIn ? (
          <Button
            onClick={onLogout}
            className="h-9 sm:h-10 md:h-12 px-3 sm:px-4 md:px-6 text-[10px] sm:text-xs md:text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all duration-200"
          >
            Sign Out
          </Button>
        ) : (
          <div className="flex gap-1 sm:gap-2">
            ...
            <Button
              ...
              className="h-9 sm:h-10 md:h-12 px-2 sm:px-3 md:px-4 text-[10px] sm:text-xs md:text-sm bg-[#0077BE] hover:bg-[#0077BE]/90 text-white font-black uppercase tracking-widest shadow-lg shadow-[#0077BE]/20 hover:scale-105 active:scale-95 transition-all duration-200"
            >
              Sign Up
            </Button>
          </div>
